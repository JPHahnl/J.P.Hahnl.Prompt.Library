...
|:--|:--|:--|
| **[Königsweg](#königsweg)** | Framework philosophy: *Clarity · Strength · Dignity* | [SysKernel_Master_prompt_v4_0.md](./SysKernel_Master_prompt_v4_0.md) |
| **[Klarheit](#klarheit-clarity)** | Code self-documents its intent and architecture | [better_naming_prompt_v3_1.md](./better_naming_prompt_v3_1.md) |
| **[Stärke](#stärke-strength)** | Resilient, performant, deterministic systems | [framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md) |
| **[Würde](#würde-dignity)** | Intentional design respecting maintainers | All prompts |
| **[Analyzer-Clean](#analyzer-clean)** | Zero warnings from all configured analyzers | [SysKernel_Master_prompt_v4_0.md](./SysKernel_Master_prompt_v4_0.md) |
| **[Analyzer Discipline](#analyzer-discipline)** | Analyzers are binding, not advisory | [SysKernel_Master_prompt_v4_0.md](./SysKernel_Master_prompt_v4_0.md) |
| **[Layered Architecture](#layered-architecture)** | Strict hierarchical dependency model: Sdk→Core→Runtime→Diagnostics | [Architecture_Verification_prompt_v3_1.md](./Architecture_Verification_prompt_v3_1.md) |
| **[SDK Foundation](#sdk-foundation)** | Build-time metadata layer (Kernel.Sdk) | [Architecture_Verification_prompt_v3_1.md](./Architecture_Verification_prompt_v3_1.md) |
| **[Null Object Pattern](#null-object-pattern)** | Intentional emptiness with deterministic no-op behavior | [Architecture_Verification_prompt_v3_1.md](./Architecture_Verification_prompt_v3_1.md) |
| **[Deterministic Build](#deterministic-build)** | Byte-identical outputs from identical inputs | [SysKernel_Master_prompt_v4_0.md](./SysKernel_Master_prompt_v4_0.md) |
| **[Runtime Determinism](#runtime-determinism)** | Identical inputs produce identical runtime results | [framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md) |
| **[AAA Pattern](#aaa-pattern)** | Arrange-Act-Assert test structure | [nunit_test_generation_prompt_v1_1.md](./nunit_test_generation_prompt_v1_1.md) |
| **[Test Categories](#test-categories)** | Classification for CI/CD filtering (Short, Architecture, Performance, etc.) | [nunit_test_generation_prompt_v1_1.md](./nunit_test_generation_prompt_v1_1.md) |
| **[Secure-by-Default](#secure-by-default)** | Default state is secure; explicit opt-out required | [Security_SafeDefaults_prompt_v3_1.md](./Security_SafeDefaults_prompt_v3_1.md) |
| **[Immutable Core](#immutable-core)** | Shared data read-only after construction | [Security_SafeDefaults_prompt_v3_1.md](./Security_SafeDefaults_prompt_v3_1.md) |
| **[STRIDE](#stride-threat-model)** | Threat categorization framework | [Security_SafeDefaults_prompt_v3_1.md](./Security_SafeDefaults_prompt_v3_1.md) |
| **[GC Pressure](#gc-pressure)** | Frequency and volume of garbage collection | [framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md) |
| **[Hot Path](#hot-path)** | Performance-critical frequently-executed code | [framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md) |
| **[AOT-Friendly](#aot-friendly)** | Compatible with Ahead-of-Time compilation | [framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md) |
| **[EventSource](#eventsource)** | Structured high-performance ETW logging | [Diagnostics_Telemetry_prompt_v3_1.md](./Diagnostics_Telemetry_prompt_v3_1.md) |
| **[EventSource Discipline](#eventsource-discipline)** | Analyzer-clean structured telemetry | [Diagnostics_Telemetry_prompt_v3_1.md](./Diagnostics_Telemetry_prompt_v3_1.md) |
| **[ActivitySource](#activitysource)** | OpenTelemetry distributed tracing | [Diagnostics_Telemetry_prompt_v3_1.md](./Diagnostics_Telemetry_prompt_v3_1.md) |
| **[Structured Logging](#structured-logging)** | Message templates with typed parameters | [Diagnostics_Telemetry_prompt_v3_1.md](./Diagnostics_Telemetry_prompt_v3_1.md) |
| **[SemVer](#semver-semantic-versioning)** | MAJOR.MINOR.PATCH versioning scheme | [API_Stability_Versioning_prompt_v3_1.md](./API_Stability_Versioning_prompt_v3_1.md) |
| **[Semantic Version Integrity](#semantic-version-integrity)** | SemVer with PublicApiAnalyzer verification | [API_Stability_Versioning_prompt_v3_1.md](./API_Stability_Versioning_prompt_v3_1.md) |
| **[Public API Surface](#public-api-surface)** | All public/protected types and members | [API_Stability_Versioning_prompt_v3_1.md](./API_Stability_Versioning_prompt_v3_1.md) |
| **[Beast Mode](#beast-mode)** | Autonomous AI execution until task completion | [BeastMode31_prompt_v3_1_1.md](./BeastMode31_prompt_v3_1_1.md) |
| **[Confidence Score](#confidence-score)** | AI analysis certainty (0.0-1.0) | [SysKernel_Master_prompt_v4_0.md](./SysKernel_Master_prompt_v4_0.md) |
| **[Thread Safety Principle](#thread-safety-principle)** | Lock-free, idempotent, async-safe resources | [thread_safety_concurrency_prompt_v3_1.md](./thread_safety_concurrency_prompt_v3_1.md) |
| **[Lock Hierarchy](#lock-hierarchy)** | Global lock ordering to prevent deadlocks | [thread_safety_concurrency_prompt_v3_1.md](./thread_safety_concurrency_prompt_v3_1.md) |
| **[Lock-Free](#lock-free)** | Atomic operations instead of locks | [thread_safety_concurrency_prompt_v3_1.md](./thread_safety_concurrency_prompt_v3_1.md) |
| **[Member Ordering](#member-ordering)** | 11-step type member declaration sequence | [better_naming_prompt_v3_1.md](./better_naming_prompt_v3_1.md) |
| **[EditorConfig Compliance](#editorconfig-compliance)** | Adherence to project-wide style rules | [framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md) |
| **[XML Documentation](#xml-documentation)** | Structured IntelliSense comments | [documentation_prompt_v3_1.md](./documentation_prompt_v3_1.md) |
| **[DevDoc](#devdoc)** | Internal maintainer documentation | [documentation_prompt_v3_1.md](./documentation_prompt_v3_1.md) |
...
**Primary Prompt:** [SysKernel_Master_prompt_v4_0.md](./SysKernel_Master_prompt_v4_0.md)
...
**Primary Prompts:**  
[better_naming_prompt_v3_1.md](./better_naming_prompt_v3_1.md)  
[Architecture_Verification_prompt_v3_1.md](./Architecture_Verification_prompt_v3_1.md)
...
**Primary Prompts:**  
[framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md)  
[thread_safety_concurrency_prompt_v3_1.md](./thread_safety_concurrency_prompt_v3_1.md)
...
[documentation_prompt_v3_1.md](./documentation_prompt_v3_1.md)  
[better_naming_prompt_v3_1.md](./better_naming_prompt_v3_1.md)
...
│      J.P.Hahnl.Kernel.Development       │
└────────────────┬────────────────────────┘
                 │
┌────────────────▼────────────────────────┐
│          Diagnostics Layer              │  (Observability)
│     J.P.Hahnl.Kernel.Diagnostics        │
└────────────────┬────────────────────────┘
                 │
┌────────────────▼────────────────────────┐
│           Runtime Layer                 │  (Execution engine)
│      J.P.Hahnl.Kernel.Runtime           │
└────────────────┬────────────────────────┘
                 │
┌────────────────▼────────────────────────┐
│            Core Layer                   │  (Primitives)
│       J.P.Hahnl.Kernel.Core             │
└────────────────┬────────────────────────┘
                 │
┌────────────────▼────────────────────────┐
│          SDK Foundation                 │  (Metadata)
│        J.P.Hahnl.Kernel.Sdk             │
└─────────────────────────────────────────┘
...
|:---|:---|:---|:---|:---|
| **Kernel.Sdk** | `J.P.Hahnl.Kernel.Sdk` | BCL only | Build-time metadata | Attributes, constants, base exceptions, T4 outputs |
| **Kernel.Core** | `J.P.Hahnl.Kernel.Core` | Sdk | Runtime primitives | Immutables, value objects, functional constructs |
| **Kernel.Runtime** | `J.P.Hahnl.Kernel.Runtime` | Core | Execution engine | DI, configuration, service hosting, lifecycle |
| **Kernel.Diagnostics** | `J.P.Hahnl.Kernel.Diagnostics` | Runtime | Observability | EventSource, logging, OpenTelemetry |
| **Kernel.Development** | `J.P.Hahnl.Kernel.Development` | All (internal) | Developer tooling | Analyzers, templates, VS integration |
| **Kernel.Tests** | `J.P.Hahnl.Kernel.Tests` | All (observer) | Validation | Unit tests, integration tests, NetArchTest |
...
**Primary Prompt:** [Architecture_Verification_prompt_v3_1.md](./Architecture_Verification_prompt_v3_1.md)
...
{
    var result = Types.InAssembly("J.P.Hahnl.Kernel.Core")
...
**See Also:** [SDK Foundation](#sdk-foundation), [Architecture Verification Prompt](./Architecture_Verification_prompt_v3_1.md)
...
// ========================================
namespace J.P.Hahnl.Kernel.Sdk;
...
// ========================================
namespace J.P.Hahnl.Kernel.Core;
...
**Primary Prompt:** [framework_architecture_performance_test_prompt_v3_1.md](./framework_architecture_performance_test_prompt_v3_1.md)
...
**Primary Prompt:** [nunit_test_generation_prompt_v1_1.md](./nunit_test_generation_prompt_v1_1.md)
...
**See Also:** [Test Categories](#test-categories), [nunit_test_generation_prompt_v1_1.md](./nunit_test_generation_prompt_v1_1.md)
...
**Primary Prompt:** [Security_SafeDefaults_prompt_v3_1.md](./Security_SafeDefaults_prompt_v3_1.md)
...
**Primary Prompts:**  
[Security_SafeDefaults_prompt_v3_1.md](./Security_SafeDefaults_prompt_v3_1.md)  
[thread_safety_concurrency_prompt_v3_1.md](./thread_safety_concurrency_prompt_v3_1.md)
...
**Sys.Kernel Standard:**
```csharp
[EventSource(Name = "J.P.Hahnl.Kernel.Diagnostics")]
...
// Collection (PerfView)
PerfView.exe collect -providers "*J.P.Hahnl.Kernel.Diagnostics" MyApp.exe

// Collection (dotnet-trace)
dotnet-trace collect --process-id $(pidof MyApp) \
  --providers J.P.Hahnl.Kernel.Diagnostics
```

**Primary Prompt:** [Diagnostics_Telemetry_prompt_v3_1.md](./Diagnostics_Telemetry_prompt_v3_1.md)
...
public sealed class TracedService
{
    private static readonly ActivitySource s_activitySource = 
        new("J.P.Hahnl.Kernel.Diagnostics", "1.0.0");
...
**Primary Prompt:** [API_Stability_Versioning_prompt_v3_1.md](./API_Stability_Versioning_prompt_v3_1.md)
...
J.P.Hahnl.Kernel.Core.ServiceRegistry
J.P.Hahnl.Kernel.Core.ServiceRegistry.Register<T>() -> void

# PublicAPI.Unshipped.txt (v1.1.0-dev)
J.P.Hahnl.Kernel.Core.ServiceRegistry.Unregister<T>() -> void  ← New API
...
**Primary Prompt:** [BeastMode31_prompt_v3_1_1.md](./BeastMode31_prompt_v3_1_1.md)
...
@invoke Architecture_Verification {
  "target": "J.P.Hahnl.Kernel.Runtime",
  "strict": true,
  "output_format": "json"
}
```
...
**Primary Prompt:** [better_naming_prompt_v3_1.md](./better_naming_prompt_v3_1.md)
...
**Primary Prompt:** [thread_safety_concurrency_prompt_v3_1.md](./thread_safety_
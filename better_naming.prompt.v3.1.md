...
- Begin with your organizational root:  
  `J.P.Hahnl.Kernel.*` or `Syntony.*`.  
- Sub-namespaces denote functionality, not technology.  
  Example:  
  `J.P.Hahnl.Kernel.Diagnostics.Logging` ✅  
  `J.P.Hahnl.Kernel.DotNet9Tools` ❌
...
- Project names reflect assembly purpose (e.g. `J.P.Hahnl.Kernel.Diagnostics`).  
- Test assemblies append `.Tests`.  
  Example:  
  `J.P.Hahnl.Kernel.Runtime.Tests`.
...
**Königsweg Naming Prompt v3.1**  
Clarity | Consistency | Analyzer-Clean | Human-Readable

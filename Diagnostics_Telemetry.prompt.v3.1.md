...
```csharp
private static readonly ActivitySource s_activity = new("J.P.Hahnl.Kernel.Diagnostics");
```
...
{
   using var listener = new TestEventListener("J.P.Hahnl.Kernel.Diagnostics");
